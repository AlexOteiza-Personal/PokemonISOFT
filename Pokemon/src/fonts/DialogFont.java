...
public class DialogFont extends BitmapFont {
    private static final FontChar[] charmap = {
	    ...
	    new FontChar('\'', 6), new FontChar('(', 6), new FontChar(')', 6),
	    new FontChar('+', 6), new FontChar(',', 4), new FontChar('-', 6),
	    new FontChar('.', 4), new FontChar('/', 6), new FontChar('0', 6),
	    new FontChar('1', 6), new FontChar('2', 6), new FontChar('3', 6),
	    new FontChar('4', 6), new FontChar('5', 5), new FontChar('6', 6),
	    ...
	    new FontChar('j', 6), new FontChar('k', 6), new FontChar('l', 4),
	    new FontChar('m', 6), new FontChar('n', 6), new FontChar('o', 6),
	    new FontChar('p', 6), new FontChar('q', 6), new FontChar('r', 6),
	    ...
	    new FontChar('À', 6), new FontChar('Á', 6), new FontChar('Â', 6), 
	    new FontChar('Ä', 6), new FontChar('Ç', 6), new FontChar('É', 6), 
	    new FontChar('È', 6), new FontChar('Ê', 6), new FontChar('Ë',6),
	    new FontChar('Ì', 6), new FontChar('Í', 6), new FontChar('Î',6),
	    new FontChar('Ï', 6), new FontChar('Ò', 6), new FontChar('Ó',6),
	    new FontChar('Ô', 6), new FontChar('Ö', 6), new FontChar('Ù',6),
	    new FontChar('Ú', 6), new FontChar('Û', 6), new FontChar('Ü',6),
	    new FontChar('Ñ', 6), new FontChar('à', 6), new FontChar('á',6),
	    new FontChar('â', 6), new FontChar('ä', 6), new FontChar('ç',6),
	    new FontChar('è', 6), new FontChar('é', 6), new FontChar('ê',6),
	    new FontChar('ë', 6), new FontChar('ì', 6), new FontChar('í',6),
	    new FontChar('î', 6), new FontChar('ï', 6), new FontChar('ò',6),
	    new FontChar('ó',6), new FontChar('ô',6), new FontChar('ö',6),
	    new FontChar('ù',6), new FontChar('ú',6), new FontChar('û',6),
